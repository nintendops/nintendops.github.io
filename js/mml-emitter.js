(function e(t, n, r) {
    ...
    }, {"./config": 2, "./emitter": 3, "./extend": 6, "./mml-parser": 10, "./mml-track": 11}],
    ...
    }, {"./expr-parser": 5, "./scanner": 12, "./syntax": 13}],
        ...
        MMLTrack.prototype._init = function (currentTime, currentTimeIncr) {
            ...
            var next = function (currentTime) {
                ...
                while (this._pos < nodes.length && currentTime < nextCurrentTime) {
                    // calling compiler[Syntax:note](ctx,currentTime);
    ...
    }, {"./emitter": 3, "./extend": 6, "./mml-compiler": 8}],
